        ...
        {articles.length === 0 && !loading ? (
          ...
          {/* <Row className="">
            ...
            <Col lg={6} data-aos="fade-right" className = " ">
                <img alt="pixels article" src={`/${articles[0].image}`} className = "m-2 img-fluid rounded" />
            </Col>

            <Col lg={6} data-aos="fade-left" className = "d-flex pl-5 align-items-center">
              <div>
                  <h3>{articles[0].title} </h3>
                  <small>Author : {articles[0].author} </small>
                  <p>
                      {articles[0].subtitle}
                  </p>
                  <div className = "mt-4">
                      <Link to={`/blog/${articles[0].id}`} className="btn btn-outline-info rounded-pill">Read More</Link>
                  </div>
              </div>
            </Col>
          </Row> */}
          ...
          <Row className="row overflow-hidden py-3">
            ...
            {articles.map((article , index)=>(
              <Col lg={4} key={index} data-aos="fade-up">
                <div className="card">
                  <img alt="pixels article" className="card-img-top" src={`/${article.image}`} />
